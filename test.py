...
parser.add_argument('--phase', required = True, help = "train or test")
parser.add_argument('--class_num', required= True, help = "class_number")
...
#parser = argparse.ArgumentParser(description='Is it a "Train" or "Test" that you want to make a list?')
#parser.add_argument('--phase', required = True, help = "train or test")
#parser.add_argument('--class_num', required= True, help = "class_number")
...
def make_file_list(args): 
    ...
    data_folder = './data/FDDB/images/' + phase + '/{}/*'.format(class_num)
...
if __name__ == '__main__':
    ...
    # testing dataset
    testset_folder = os.path.join('data', args.dataset, 'images/{}/{}/'.format(args.phase, args.class_num))
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        if args.save_image:
            ...
            name = "./results/" + str(args.phase) + '/' + str(class_num) + '/output_{}.jpg'.format(img_name)
            print(name) 
